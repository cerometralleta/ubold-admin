...
//    public Response index(IndexParam indexParam) {
//        logger.info("rabc::UserController::index::{}", JSONObject.toJSONString(indexParam));
//        return Response.SUCCESS();
//    }
//
//    @RequestMapping(value = "/index", method = RequestMethod.GET)
//    public Response index2(IndexParam indexParam) {
//        logger.info("rabc::UserController::auth index::{}", JSONObject.toJSONString(indexParam));
//        return Response.SUCCESS();
//    }
//
